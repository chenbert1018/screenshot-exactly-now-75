...
function FanWeatherPage() {
  ...
  }, [ready, event?.id, event?.city, event?.date]);
    ...
    <AppShell>
      <div className="pb-12">
        ...
        <section className="relative overflow-hidden rounded-[2rem] border border-border/60 bg-card shadow-soft">
          <span
            aria-hidden
            className="pointer-events-none absolute top-5 right-6 text-xl text-primary/25"
          >
            ✦
          </span>
        ...
        {!weatherLoading && !weatherError && weather && weatherInput && (
          <>
            <SoftCard className="mt-5 overflow-hidden px-5 py-5">
              ...
              <>
                <section className="mt-6">
                  <div className="mb-3 px-1">
                    <p className="text-xs tracking-wide text-muted-foreground">BEFORE WE MEET ♡</p>
                  </div>
