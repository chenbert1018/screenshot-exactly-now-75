...
function base(label: string) {
  ...
  ctx.fillStyle = ACCENT; ctx.font = "600 39px 'Noto Sans TC', sans-serif"; ctx.fillText(label, 82, 120);
  ctx.fillStyle = MUTED; ctx.font = "500 30px 'Noto Sans TC', sans-serif"; ctx.fillText(dateStamp(), 82, 165);
...
function footer(ctx: CanvasRenderingContext2D, copy: string) {
  ...
  ctx.fillStyle = MUTED; ctx.font = "400 32px 'Noto Sans TC', sans-serif"; ctx.fillText(copy, 82, 1810);
...
function row(ctx: CanvasRenderingContext2D, label: string, value: string, y: number) {
  ...
  ctx.fillStyle = MUTED; ctx.font = "500 34px 'Noto Sans TC', sans-serif"; ctx.fillText(label.toUpperCase(), 116, y + 43);
  ctx.fillStyle = INK; ctx.font = "650 44px 'Noto Sans TC', sans-serif"; ctx.fillText(value.slice(0, 32), 116, y + 96);
}
...
export async function shareTodaySongCard(input: TodaySongShare) {
  ...
  ctx.fillStyle = MUTED; ctx.font = "400 36px 'Noto Sans TC', sans-serif";
  ...
  ctx.fillStyle = ACCENT; ctx.font = "600 32px 'Noto Sans TC', sans-serif"; ctx.fillText("NOW PLAYING", 116, 510);
  ctx.fillStyle = INK; ctx.font = "700 55px 'Noto Sans TC', sans-serif"; ctx.fillText(input.title.slice(0, 22), 116, 615);
  if (input.artist) { ctx.fillStyle = MUTED; ctx.font = "400 38px 'Noto Sans TC', sans-serif"; ctx.fillText(input.artist.slice(0, 28), 116, 670); }
  ctx.strokeStyle = "rgba(139,114,158,.28)"; ctx.lineWidth = 2; ctx.beginPath(); ctx.moveTo(116, 735); ctx.lineTo(620, 735); ctx.stroke();
  ctx.fillStyle = MUTED; ctx.font = "400 38px 'Noto Sans TC', sans-serif"; ctx.fillText("♪  play this moment again", 116, 790);
  if (input.mood) {
    ctx.fillStyle = "rgba(139,114,158,.12)"; ctx.beginPath(); ctx.roundRect(112, 825, 360, 74, 37); ctx.fill();
    ctx.fillStyle = ACCENT; ctx.font = "500 34px 'Noto Sans TC', sans-serif"; ctx.fillText(`TODAY'S MOOD   ${input.mood}`, 142, 873);
  }

  ctx.fillStyle = "rgba(139,114,158,.72)"; ctx.font = "600 32px 'Noto Sans TC', sans-serif";
  ...
  ctx.fillStyle = MUTED; ctx.font = "400 38px 'Noto Sans TC', sans-serif";
...
export async function shareComebackEraCard(input: EraShare) {
  ...
  ctx.fillStyle = MUTED; ctx.font = "400 34px 'Noto Sans TC', sans-serif"; ctx.fillText("MY ERA MEMORY · keep this comeback close", 84, 337);
  ...
  if (input.note) {
    ...
    ctx.fillStyle = MUTED; ctx.font = "500 28px 'Noto Sans TC', sans-serif"; ctx.fillText("ONE LINE FOR THIS ERA", 116, y + 60);
    ctx.fillStyle = INK; ctx.font = "400 38px 'Noto Sans TC', sans-serif"; ctx.fillText(`“ ${input.note.slice(0, 36)} ”`, 116, y + 125);
  } else {
